...
# Test Case 2 - Request con parametros de tabla existente (Tabla 'personas')

echo "Realizando GET request hacia localhost:8080/query/personas..."

curl -s http://localhost:8080/query/personas | jq .